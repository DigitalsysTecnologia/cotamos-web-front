<template>
  <div style="overflow-x:hidden;">
    ...
    <div class="row" v-if="isLoading">
      <Loading :messages="['Carregando suas ofertas', 'Aguarde um instante por favor']"/>
    </div>
    <div class="row" v-else>
      <div class="col-xs-12 col-md-8 col-md-offset-2 carousel-container">
        <h2 style="margin-top:20px;" class="text-center">Suas Ofertas Disponíveis </h2>
        <Carousel :per-page="1" 
                  :mouse-drag="true" 
                  :navigationEnabled="showCarouselNavigation()" 
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4 col-xs-12 text-center" v-if="plan.code != 'pet_senior'">
                        <div class="col-xs-12">
                          ...
                          <a href="#" v-on:click="showCoverageModal(plan)">Ver Detalhes</a>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-4 col-xs-12 text-center health-network-container" v-if="plan.code != 'pet_senior'">
                        ...
                        <a href="#" v-on:click="showNetworkModal(plan)" style="display:block;margin-top:10px;">Ver Clínicas</a>
                      </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-header">
                <h4 class="modal-title card-subtitle">Coberturas</h4>
              </div>
        ...
        <div class="modal" id="networkModal">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <!-- Modal Header -->
              <div class="modal-header">
                <h4 class="modal-title card-subtitle">Clínicas Próximas a Você</h4>
              </div>
        ...
        <div class="modal" id="confirmModal">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <!-- Modal Header -->
              <div class="modal-header">
                <h4 class="modal-title card-subtitle">Obrigado</h4>
              </div>
