<template>
    <div>
        ...
        <main class="container-fluid">
            <div class="row">
                <header class="col-xs-12 banner-pgs banner"
        ...
        <section class="container-fluid bg-outros" v-if="proposal">
            <div class="row">
                <div class="container">
                    <div class="row">
                        <section class="col-xs-12 formulario-cotacao">
                            <div class="col-sm-12 col-xs-12 box-cotacao">
                              <div>
                                ...
                                <h3 v-if="places && places.length > 0">Você tem <span style="font-weight: bold;color: black;">{{places.length}}</span> clínicas próximas a sua residência</h3>
...
export default {
  ...
  methods: {
    ...
    selectPlan: async function(plan) {
      ...
      this.proposal.selectedPlan = plan; 
