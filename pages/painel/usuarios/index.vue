<template>
  <v-layout row wrap>
    <v-flex sm10 offset-sm1 xs12>
      <h1>Usuários</h1>
      <v-btn :block="false" color="primary" @click="createUser">Criar Usuário</v-btn>
      <v-data-table :headers="headers" :items="items" :loading="items.length == 0" no-data-text="" hide-actions class="elevation-1">
